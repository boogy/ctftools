...
7. [one_gadget](https://github.com/david942j/one_gadget) A tool for you easy to find the execve gadget in libc.so.6
...
7. [xssValidator](https://github.com/nVisium/xssValidator)
